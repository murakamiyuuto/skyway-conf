...
***************************************************************************** */
        ...
        function A(e, t, n) {
          ...
          var r,
            i = new x(e);
          return (
            t !== m && nt("onBecomeObserved", i, t, r), n !== m && tt(i, n), i
          );
        }
        var O = {
        ...
        var q = V(L),
          W = V(function (e, t, n) {
            return null == e || Zt(e) || Dt(e) || qt(e) || Ht(e)
              ? e
              : Array.isArray(e)
        ...
        var J,
          X,
          Z = F(!1, function (e, t, n, r, i) {
            var s = n.get,
              a = n.set,
              u = i[0] || {};
            Yt(e).addComputedProp(e, t, o({ get: s, set: a, context: e }, u));
          }),
          ee = Z({ equals: O.structural }),
          te = function (e, t, n) {
        ...
        function ie(e) {
          switch (e.dependenciesState) {
            ...
            case J.POSSIBLY_STALE:
              for (
                var t = de(!0), n = ce(), r = e.observing, i = r.length, o = 0;
                o < i;
                o++
              ) {
                var s = r[o];
        ...
        function oe(e) {
          ...
          Pe.computationDepth > 0 && t && f(!1),
            Pe.allowStateChanges ||
              (!t && "strict" !== Pe.enforceActions) ||
              f(!1);
        }
        function se(e, t, n) {
          var r = de(!0);
          ...
          Se = (function () {
            function e(e) {
              (this.dependenciesState = J.NOT_TRACKING),
                ...
                e.set && (this.setter = ye(this.name + "-setter", e.set)),
                (this.equals =
                  e.equals ||
        ...
        var Ae = !0,
          ...
          Pe = (function () {
            ...
            return (
              ...
              e.__mobxGlobals &&
                e.__mobxGlobals.version !== new Ce().version &&
                (Ae = !1),
              Ae
                ? e.__mobxGlobals
                  ? ((e.__mobxInstanceCount += 1),
                    e.__mobxGlobals.UNCHANGED ||
                      (e.__mobxGlobals.UNCHANGED = {}),
                    e.__mobxGlobals)
                  : ((e.__mobxInstanceCount = 1), (e.__mobxGlobals = new Ce()))
                : (setTimeout(function () {
                    Oe ||
                      f(
        ...
        function Fe(e) {
          ...
          return null !== t
            ? (t.runId !== e.lastAccessedBy &&
              ...
              !0)
            : (0 === e.observers.size && Pe.inBatch > 0 && Re(e), !1);
        }
        function Ie(e, t) {
          if (
            (console.log(
        ...
        var Ye = function (e, t, n, r) {
          return 1 === arguments.length && "function" == typeof e
            ...
            : void v(e, t, ye(e.name || t, n.value, this));
        };
        function Ke(e, t) {
        ...
        function rt(e) {
          ...
          if (
            (!0 === e.isolateGlobalState &&
              ...
              (Oe = !0),
              Ae &&
                (0 == --Te().__mobxInstanceCount &&
                  (Te().__mobxGlobals = void 0),
                (Pe = new Ce()))),
            void 0 !== t)
          ) {
            var u = void 0;
            ...
            (Pe.enforceActions = u),
              (Pe.allowStateChanges = !0 !== u && "strict" !== u);
          }
          void 0 !== n && (Pe.computedRequiresReaction = !!n),
            void 0 !== s && (Pe.reactionRequiresObservable = !!s),
            void 0 !== a &&
              ((Pe.observableRequiresReaction = !!a),
              (Pe.allowStateReads = !Pe.observableRequiresReaction)),
            void 0 !== r && (Pe.computedConfigurable = !!r),
            void 0 !== i &&
              (!0 === i &&
                console.warn(
                  "WARNING: Debug feature only. MobX will NOT recover from errors when `disableErrorBoundaries` is enabled."
                ),
              (Pe.disableErrorBoundaries = !!i)),
            o && qe(o);
        }
        function it(e, t) {
        ...
        function dt(e, t) {
          return (
            null != e &&
            (void 0 !== t
              ? !!Zt(e) && e[C].values.has(t)
              : Zt(e) || !!e[C] || T(e) || ze(e) || ke(e))
          );
        }
        function ft(e) {
          ...
          get: function (e, t) {
            return t === C
              ...
              ? Ft.hasOwnProperty(t)
                ? Ft[t]
                : e[t]
              : Ft.get.call(e, parseInt(t));
          },
          set: function (e, t, n) {
            return (
              "length" === t && e[C].setArrayLength(n),
              "number" == typeof t && Ft.set.call(e, t, n),
              "symbol" == typeof t || isNaN(t)
                ? (e[t] = n)
                : Ft.set.call(e, parseInt(t), n),
              !0
            );
          },
          preventExtensions: function (e) {
        ...
        var Bt = (function () {
            function e(e, t, n) {
              (this.owned = n),
                ...
                (this.atom = new x(e || "ObservableArray@" + d())),
        ...
        var It,
          Lt = b("ObservableArrayAdministration", Bt);
        function Dt(e) {
          return g(e) && Lt(e[C]);
        }
        var Vt,
          ...
          zt = (function () {
            ...
            return (
              ...
              (e.prototype.delete = function (e) {
                ...
                if (
                  Tt(this) &&
                  !(r = Ot(this, { type: "delete", object: this, name: e }))
                )
                  return !1;
                if (this._has(e)) {
                  var n = Pt(this),
          ...
          Gt = (function () {
            ...
            return (
              ...
              (e.prototype.clear = function () {
                ...
                bt(function () {
                  ue(function () {
                    ...
                    try {
                      for (
                        var r = s(e._data.values()), i = r.next();
                        !i.done;
                        i = r.next()
                      ) {
                        var o = i.value;
              ...
              (e.prototype.add = function (e) {
                var t = this;
                if (
                  (oe(this._atom), Tt(this)) &&
                  !(r = Ot(this, { type: "add", object: this, newValue: e }))
                )
                  return this;
                if (!this.has(e)) {
                  bt(function () {
              ...
              (e.prototype.delete = function (e) {
                ...
                if (
                  Tt(this) &&
                  !(r = Ot(this, { type: "delete", object: this, oldValue: e }))
                )
                  return !1;
                if (this.has(e)) {
                  var n = Pt(this),
        ...
        function Yt(e, t, n) {
          if (
            ...
            return e[C];
          y(e) || (t = (e.constructor.name || "ObservableObject") + "@" + d()),
        ...
        function en(e, t) {
          if ("object" == typeof e && null !== e) {
            ...
            var r;
            if ((B(e), t && !e[C] && e[t], Zt(e)))
              return t ? ((r = e[C].values.get(t)) || f(!1), r) : f(!1);
        ...
        function tn(e, t) {
          return (
            ...
            void 0 !== t
              ? tn(en(e, t))
              : T(e) || ke(e) || ze(e) || qt(e) || Ht(e)
              ? e
              : (B(e), e[C] ? e[C] : void f(!1))
          );
        }
        ...
        function rn(e, t, n) {
          return (
            ...
            (function e(t, n, r, i, o) {
              ...
              if (t != t) return n != n;
              var s = typeof t;
              if ("function" !== s && "object" !== s && "object" != typeof n)
                return !1;
              var a = nn.call(t);
              ...
              if ((i.push(t), o.push(n), u)) {
                ...
                for (; d--; )
                  if (((p = f[d]), !sn(n, p) || !e(t[p], n[p], r - 1, i, o)))
                    return !1;
              }
  ...
  \************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                "undefined" != typeof Blob &&
                  ...
                  (e.exports = r ? (i ? Blob : u) : o ? a : void 0);
              },
  ...
  \**********************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                e.exports = function (e, t) {
                  if (
                    ("string" == typeof t && (t = e[t]), "function" != typeof t)
                  )
                ...
                (function (r) {
                  (t.log = function (...e) {
                    ...
                    (t.load = function () {
                      ...
                      return (
                        !e && void 0 !== r && "env" in r && (e = r.env.DEBUG), e
                      );
                    }),
                    (t.useColors = function () {
                      return (
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                e.exports = function (e) {
                  ...
                  return (
                    ...
                    (r.humanize = n(/*! ms */ "./node_modules/ms/index.js")),
  ...
  \*****************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                  ...
                  i = n(
                    /*! component-emitter */ "./node_modules/engine.io-client/node_modules/component-emitter/index.js"
                  ),
                  o = n(/*! debug */ "./node_modules/debug/src/browser.js")(
                ...
                (e.exports = l),
                  ...
                  (l.prototype.probe = function (e) {
                    ...
                    function d(e) {
                      t &&
                        e.name !== t.name &&
                        (o('"%s" works - aborting "%s"', e.name, t.name), s());
                    }
                    function f() {
  ...
  \*********************************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                  ...
                  a = n(/*! debug */ "./node_modules/debug/src/browser.js")(
                ...
                (e.exports = l),
                  ...
                  "undefined" != typeof document &&
                    ("function" == typeof attachEvent
                      ...
                      : "function" == typeof addEventListener &&
                        addEventListener(
                          "onpagehide" in u ? "pagehide" : "unload",
                          f,
                          !1
                        ));
              },
  ...
  \*****************************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                  ...
                  u = n(/*! debug */ "./node_modules/debug/src/browser.js")(
                ...
                s(l, r),
                  ...
                  (l.prototype.onData = function (e) {
                    ...
                    u("polling got data %s", e),
                      o.decodePayload(e, this.socket.binaryType, function (
                        e,
                        n,
                        r
                      ) {
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                (function (t) {
                  var r,
                    ...
                    l = n(/*! debug */ "./node_modules/debug/src/browser.js")(
                  ...
                  function f(e) {
                    e && e.forceBase64 && (this.supportsBinary = !1),
                      ...
                      this.usingBrowserWebSocket || (d = i),
                      o.call(this, e);
                  }
                  (e.exports = f),
                    u(f, o),
                    ...
                    (f.prototype.check = function () {
                      return !(
                        !d ||
                        ("__initialize" in d && this.name === f.prototype.name)
                      );
                    });
                }.call(
                  this,
                  ...
                  (t.decodePayload = function (e, n, r) {
                    ...
                    for (var o, s, a = "", u = 0, c = e.length; u < c; u++) {
                      ...
                      if (":" === l) {
                        ...
                        if (a != (s = e.substr(u + 1, o)).length)
                          return r(h, 0, 1);
                        if (s.length) {
                          if (
                            ((i = t.decodePacket(s, n, !1)),
                        ...
                        return (
                          t.forEach(function (e) {
                            ...
                            for (s = 0; s < a.length; s++)
                              i[o++] = parseInt(a[s]);
                            for (
                              i[o++] = 255, r = new Uint8Array(n), s = 0;
                              s < r.length;
                              s++
                            )
                              i[o++] = r[s];
                    ...
                    for (var i = e, o = []; i.byteLength > 0; ) {
                      ...
                      if (u)
                        try {
                          ...
                          for (d = "", l = 0; l < f.length; l++)
                            d += String.fromCharCode(f[l]);
                        }
                      o.push(d), (i = s(i, c));
                    }
                    var p = o.length;
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                (function (t) {
                  var r = function (e) {
                    ...
                    i = r(
                      n(
                        /*! ./enumItem */ "./node_modules/enum/dist/enumItem.js"
                      )
                    ),
                    o = n(/*! ./isType */ "./node_modules/enum/dist/isType.js")
                      .isString,
                    s = n(
                      /*! ./indexOf */ "./node_modules/enum/dist/indexOf.js"
                    ).indexOf,
                    a = r(
                      n(/*! is-buffer */ "./node_modules/is-buffer/index.js")
                    ),
                    u = (function () {
                      function e(t, n) {
                        var r = this;
                        if (
                          ...
                          (this._options.endianness =
                            this._options.endianness || "LE"),
                          (this._options.ignoreCase =
                            this._options.ignoreCase || !1),
                        ...
                        (this._enumMap = t),
                          this._options.ignoreCase &&
                            (this.getLowerCaseEnums = function () {
                              for (
                                var e = {}, t = 0, n = this.enums.length;
                                t < n;
                                t++
                              )
                                e[this.enums[t].key.toLowerCase()] = this.enums[
                                  t
                                ];
                              return e;
                            }),
                          ...
                          (this.isFlaggable = (function () {
                            for (var e = 0, t = r.enums.length; e < t; e++) {
                              var n = r.enums[e];
                              if (0 === n.value || n.value & (n.value - 1))
                                return !1;
                            }
                            return !0;
                          })()),
                      ...
                      return (
                        ...
                        (e.prototype.get = function (e, t) {
                          if (null != e) {
                            if (
                              (a(e) &&
                                (e = e["readUInt32" + this._options.endianness](
                                  t || 0
                                )),
                              i.isEnumItem(e))
                            ) {
                              ...
                              if (
                                !this.isFlaggable ||
                                (this.isFlaggable &&
                                  e.key.indexOf(this._options.separator) < 0)
                              )
                                return;
                            ...
                            if (o(e)) {
                              ...
                              if (
                                (this._options.ignoreCase &&
                                  ((n = this.getLowerCaseEnums()),
                                  (e = e.toLowerCase())),
                                e.indexOf(this._options.separator) > 0)
                              ) {
                                for (
                                  var r = e.split(this._options.separator),
                                    u = 0,
                                    c = 0;
                                  c < r.length;
                                  c++
                            ...
                            for (var l in this)
                              if (this.hasOwnProperty(l) && this[l].value === e)
                                return this[l];
                            var d = null;
                            if (this.isFlaggable)
                              for (var f in this)
                        ...
                        (e.prototype.set = function (e, t, n) {
                          var r = this.get(n);
                          if (r)
                            return e["writeUInt32" + this._options.endianness](
                              r.value,
                              t || 0
                            );
                        }),
                                ...
                                if (
                                  ...
                                  for (var r in n)
                                    n.hasOwnProperty(r) &&
                                      ...
                                      n.__defineSetter__(r, function (e) {
                                        throw TypeError(
                        ...
                        (e.register = function () {
                          var n =
                            void 0 === arguments[0] ? "Enum" : arguments[0];
                          t[n] || (t[n] = e);
                        }),
                        e
                      );
                  ...
                  a = (function () {
                    ...
                    return (
                      (e.prototype.has = function (t) {
                        return e.isEnumItem(t)
                          ? 0 != (this.value & t.value)
                          : s(t)
                          ? this._options.ignoreCase
                            ? this.key.toLowerCase().indexOf(t.toLowerCase()) >=
                              0
                            : this.key.indexOf(t) >= 0
                          : 0 != (this.value & t);
                      }),
                      (e.prototype.is = function (t) {
                        return e.isEnumItem(t)
                          ...
                          : s(t)
                          ? this._options.ignoreCase
                            ? this.key.toLowerCase() === t.toLowerCase()
                            : this.key === t
                          : this.value === t;
                      }),
                      (e.prototype.toString = function () {
                      ...
                      (e.isEnumItem = function (t) {
                        return (
                          t instanceof e ||
                          (o(t) && void 0 !== t.key && void 0 !== t.value)
                        );
                      }),
                      e
                    );
  ...
  \************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                e.exports = n(
                  /*! ./dist/enum */ "./node_modules/enum/dist/enum.js"
                );
              },
                ...
                (e.exports = o),
                  (s.prototype.unpack = function () {
                    ...
                    switch (t) {
                      ...
                      case 216:
                        return (
                          (e = this.unpack_uint16()), this.unpack_string(e)
                        );
                      case 217:
                        return (
                          (e = this.unpack_uint32()), this.unpack_string(e)
                        );
                      case 218:
                  ...
                  (s.prototype.unpack_double = function () {
                    ...
                    return (
                      (0 == e >> 31 ? 1 : -1) *
                      (((1048575 & e) | 1048576) * Math.pow(2, n - 20) +
                        t * Math.pow(2, n - 52))
                    );
                  }),
                      ...
                      if (null === e) this.bufferBuilder.append(192);
                        ...
                        if (n == Array) this.pack_array(e);
                          ...
                          if ("function" != typeof e.toBinaryPack)
                            throw new Error(
                              'Type "' + n.toString() + '" not yet supported'
                            );
                  ...
                  (a.prototype.pack_object = function (e) {
                    ...
                    if (t <= 15) this.pack_uint8(128 + t);
                      ...
                      this.bufferBuilder.append(222), this.pack_uint16(t);
                    else {
                      if (!(t <= 4294967295)) throw new Error("Invalid length");
                      this.bufferBuilder.append(223), this.pack_uint32(t);
                    }
                    for (var n in e)
                      e.hasOwnProperty(n) && (this.pack(n), this.pack(e[n]));
                  }),
                  ...
                  (a.prototype.pack_uint64 = function (e) {
                    ...
                    this.bufferBuilder.append((4278190080 & t) >>> 24),
                      ...
                      this.bufferBuilder.append((65280 & t) >>> 8),
                      this.bufferBuilder.append(255 & t),
                      this.bufferBuilder.append((4278190080 & n) >>> 24),
                      this.bufferBuilder.append((16711680 & n) >>> 16),
                      this.bufferBuilder.append((65280 & n) >>> 8),
                      this.bufferBuilder.append(255 & n);
                  }),
                ...
                "undefined" != typeof window &&
                  ...
                  (i.prototype.flush = function () {
                    if (this._pieces.length > 0) {
                      ...
                      n.useArrayBufferView || (e = e.buffer),
                        this._parts.push(e),
                        (this._pieces = []);
                    }
                  }),
                  (i.prototype.getBuffer = function () {
                    if ((this.flush(), n.useBlobBuilder)) {
                      for (
                        var e = new r(), t = 0, i = this._parts.length;
                        t < i;
                        t++
                      )
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                (function (e) {
                  ...
                  function O(e, t, n) {
                    ...
                    for (var o = "", s = t; s < n; ++s)
                      o +=
                        (r = e[s]) < 16 ? "0" + r.toString(16) : r.toString(16);
                    return o;
                  }
                  function P(e, t, n) {
                    for (
                  ...
                  function F(e, t, n, r, o) {
                    return (
                      o || B(e, 0, n, 4), i.write(e, t, n, r, 23, 4), n + 4
                    );
                  }
                  function I(e, t, n, r, o) {
                    return (
                      o || B(e, 0, n, 8), i.write(e, t, n, r, 52, 8), n + 8
                    );
                  }
                  (t.Buffer = u),
                    ...
                    (u.prototype.readUInt16LE = function (e, t) {
                      return (
                        t || N(e, 2, this.length), this[e] | (this[e + 1] << 8)
                      );
                    }),
                    (u.prototype.readUInt16BE = function (e, t) {
                      return (
                        t || N(e, 2, this.length), (this[e] << 8) | this[e + 1]
                      );
                    }),
                    ...
                    (u.prototype.readFloatLE = function (e, t) {
                      return (
                        t || N(e, 4, this.length), i.read(this, e, !0, 23, 4)
                      );
                    }),
                    (u.prototype.readFloatBE = function (e, t) {
                      return (
                        t || N(e, 4, this.length), i.read(this, e, !1, 23, 4)
                      );
                    }),
                    (u.prototype.readDoubleLE = function (e, t) {
                      return (
                        t || N(e, 8, this.length), i.read(this, e, !0, 52, 8)
                      );
                    }),
                    (u.prototype.readDoubleBE = function (e, t) {
                      return (
                        t || N(e, 8, this.length), i.read(this, e, !1, 52, 8)
                      );
                    }),
  ...
  \*************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                e.exports = { STRING: 2, BOOLEAN: 4, NUMBER: 8 };
              },
                  ...
                  return function (t) {
                    ...
                    switch (typeof t) {
                      ...
                      case "number":
                        return r.NUMBER;
                      case "symbol":
                        return Symbol.keyFor && Symbol.keyFor(t)
                          ? Symbol.keyFor(t).length * r.STRING
                          : (t.toString().length - 8) * r.STRING;
                      case "object":
                        return Array.isArray(t)
                          ? t.map(s(e)).reduce(function (e, t) {
                              return e + t;
                            }, 0)
                          : o(e, t);
                      default:
  ...
  \***********************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                t.Interop = n(
                  /*! ./interop */ "./node_modules/sdp-interop/lib/interop.js"
                );
              },
  ...
  \*************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                "use strict";
                var r = n(
                    /*! ./transform */ "./node_modules/sdp-interop/lib/transform.js"
                  ),
                  i = n(
                    /*! ./array-equals */ "./node_modules/sdp-interop/lib/array-equals.js"
                  );
                function o() {
                  this.cache = { mlB2UMap: {}, mlU2BMap: {} };
                }
                (e.exports = o),
                  (o.prototype.candidateToUnifiedPlan = function (e) {
                    var t = new RTCIceCandidate(e);
                    return (
                      (t.sdpMLineIndex = this.cache.mlB2UMap[t.sdpMLineIndex]),
                      t
                    );
                  }),
                  (o.prototype.candidateToPlanB = function (e) {
                    ...
                    if (0 === t.sdpMid.indexOf("audio")) t.sdpMid = "audio";
                      ...
                      if (0 !== t.sdpMid.indexOf("video"))
                        throw new Error(
                          "candidate with " + t.sdpMid + " not allowed"
                        );
                      t.sdpMid = "video";
                    }
                    return (
                      (t.sdpMLineIndex = this.cache.mlU2BMap[t.sdpMLineIndex]),
                      t
                    );
                  }),
                    ...
                    if (t && t.media && Array.isArray(t.media))
                      for (var n = 0; n < t.media.length; n++)
                        if (
                          t.media[n].type == e &&
                          (!t.media[n].direction ||
                            "sendrecv" === t.media[n].direction ||
                            "sendonly" === t.media[n].direction)
                        )
                          return n;
                    return null;
                  }),
                  (o.prototype.toPlanB = function (e) {
                    ...
                    if (
                      ...
                      return (
                        console.warn(
                          "An empty description was passed as an argument."
                        ),
                        e
                      );
                    var n = r.parse(e.sdp);
                    ...
                    if (
                      n.media.length <= 3 &&
                      n.media.every(function (e) {
                        return -1 !== ["video", "audio", "data"].indexOf(e.mid);
                      })
                    )
                      return (
                        console.warn(
                          "This description does not look like Unified Plan."
                        ),
                        e
                      );
                    for (var i = e.sdp, o = !1, a = 0; a < n.media.length; a++)
                      n.media[a].rtp.forEach(function (e) {
                        if ("NULL" === e.codec) {
                          o = !0;
                    ...
                    u.forEach(function (e) {
                      ...
                      (void 0 !== c[e.type] &&
                        "inactive" !== c[e.type].direction) ||
                        (c[e.type] = e);
                    }),
                      u.forEach(function (e) {
                        var t = e.type;
                        if ("application" === t)
                          return n.media.push(e), void l.push(e.mid);
                        "object" == typeof e.sources &&
                          Object.keys(e.sources).forEach(function (n) {
                            "object" != typeof c[t].sources &&
                              (c[t].sources = {}),
                              (c[t].sources[n] = e.sources[n]),
                              void 0 !== e.msid &&
                                (c[t].sources[n].msid = e.msid);
                          }),
                          void 0 !== e.ssrcGroups &&
                            Array.isArray(e.ssrcGroups) &&
                            ((void 0 !== c[t].ssrcGroups &&
                              Array.isArray(c[t].ssrcGroups)) ||
                              (c[t].ssrcGroups = []),
                            (c[t].ssrcGroups = c[t].ssrcGroups.concat(
                              e.ssrcGroups
                            )));
                        var r = e.direction;
                        (d[t] = (d[t] || 0) | s[r || "inactive"]),
                          c[t] === e &&
                            ((e.mid = t),
                            delete e.bundleOnly,
                            delete e.msid,
                      ...
                      n.groups.some(function (e) {
                        if ("BUNDLE" === e.type)
                          return (e.mids = l.join(" ")), !0;
                      }),
                      (n.msidSemantic = { semantic: "WMS", token: "*" });
                    var f = r.write(n);
                    return new RTCSessionDescription({ type: e.type, sdp: f });
                  }),
                  (o.prototype.toUnifiedPlan = function (e) {
                    ...
                    if (
                      ...
                      return (
                        console.warn(
                          "This description does not look like Plan B."
                        ),
                        e
                      );
                    var o = [];
                    ...
                    if (
                      (void 0 !== n.groups &&
                        ...
                        (a = n.groups.every(function (e) {
                          return (
                            "BUNDLE" !== e.type ||
                            i.apply(e.mids.sort(), [o.sort()])
                          );
                        })),
                      !a)
                    )
                    ...
                    void 0 !== this.cache[e.type] &&
                      (s = r.parse(this.cache[e.type]));
                    var u = { audio: {}, video: {} },
                      c = {},
                      l = 0,
                      d = 0;
                    if (
                      (n.media.forEach(function (n) {
                        if (
                          ("string" != typeof n.rtcpMux ||
                            "rtcp-mux" !== n.rtcpMux) &&
                          "inactive" !== n.direction
                        )
                          throw new Error(
                            ...
                            Object.keys(r).forEach(function (i) {
                              ...
                              if ("offer" !== e.type || r[i].msid)
                                if (
                                  ...
                                  (y.sources[i] = r[i]), delete r[i].msid;
                                else {
                                  if (
                                    ((y = Object.create(n)),
                                    (g[i] = y),
                                    void 0 !== r[i].msid &&
                                      ((y.msid = r[i].msid), delete r[i].msid),
                                    (y.sources = {}),
                                    (y.sources[i] = r[i]),
                                    (y.ssrcGroups = m[i]),
                                    void 0 !== s &&
                                  ...
                                  (y.candidates = o),
                                    ...
                                    (y.port = h),
                                    (c[y.mid] = y),
                                    (t.cache.mlU2BMap[d] = l),
                                    void 0 === t.cache.mlB2UMap[l] &&
                                      (t.cache.mlB2UMap[l] = d),
                                    d++;
                                }
                              else u[n.type][i] = r[i];
                            }),
                      ...
                      for (var f = 0; f < s.media.length; f++) {
                        ...
                        void 0 === c[p.mid] &&
                          ...
                          delete p.sources,
                          delete p.ssrcGroups,
                          p.direction && "sendrecv" !== p.direction
                            ? "sendonly" === p.direction &&
                              (p.direction = "inactive")
                            : (p.direction = "recvonly")),
                          n.media.push(p),
                          "string" == typeof p.mid && o.push(p.mid);
                      }
                    else
                      void 0 !== s &&
                        void 0 !== s.media &&
                        ...
                        s.media.forEach(function (e) {
                          o.push(e.mid),
                            void 0 !== c[e.mid]
                              ? n.media.push(c[e.mid])
                              : (delete e.msid,
                                delete e.sources,
                                delete e.ssrcGroups,
                                (e.direction && "sendrecv" !== e.direction) ||
                                  (e.direction = "recvonly"),
                                (e.direction && "sendonly" !== e.direction) ||
                        ...
                        Object.keys(c).forEach(function (e) {
                          -1 === o.indexOf(e) &&
                            (o.push(e),
                            "recvonly" === c[e].direction
                              ? n.media.some(function (t) {
                                  if (
                                    ("sendrecv" === t.direction ||
                                      "sendonly" === t.direction) &&
                                    t.type === c[e].type
                                  )
                                    return (
                                      Object.keys(c[e].sources).forEach(
                                        function (n) {
                    ...
                    ["audio", "video"].forEach(function (e) {
                      if (n && n.media && Array.isArray(n.media)) {
                        var r = null;
                        if (
                          Object.keys(u[e]).length > 0 &&
                          null === (r = t.getFirstSendingIndexFromAnswer(e))
                        )
                      ...
                      n.groups.some(function (e) {
                        if ("BUNDLE" === e.type)
                          return (e.mids = o.join(" ")), !0;
                      }),
                      (n.msidSemantic = { semantic: "WMS", token: "*" });
                    var h = r.write(n);
                    return (
                      (this.cache[e.type] = h),
                      new RTCSessionDescription({ type: e.type, sdp: h })
                    );
                  });
                var s = { inactive: 0, recvonly: 1, sendonly: 2, sendrecv: 3 };
              },
  ...
  \***************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                  /*! sdp-transform */ "./node_modules/sdp-interop/node_modules/sdp-transform/lib/index.js"
                );
                  ...
                  return (
                    void 0 !== e &&
                      ...
                      e.media.forEach(function (e) {
                        void 0 !== e.sources &&
                          0 !== Object.keys(e.sources).length &&
                          ((e.ssrcs = []),
                          Object.keys(e.sources).forEach(function (t) {
                            var n = e.sources[t];
                          ...
                          void 0 !== e.ssrcGroups &&
                            Array.isArray(e.ssrcGroups) &&
                            e.ssrcGroups.forEach(function (e) {
                              void 0 !== e.ssrcs &&
                                Array.isArray(e.ssrcs) &&
                                (e.ssrcs = e.ssrcs.join(" "));
                            });
                      }),
                    void 0 !== e &&
                      void 0 !== e.groups &&
                        ...
                        t.media.forEach(function (e) {
                          void 0 !== e.ssrcs &&
                            ...
                            void 0 !== e.ssrcGroups &&
                              Array.isArray(e.ssrcGroups) &&
                              e.ssrcGroups.forEach(function (e) {
                                "string" == typeof e.ssrcs &&
                                  (e.ssrcs = e.ssrcs.split(" "));
                              });
                        }),
                      void 0 !== t &&
                        void 0 !== t.groups &&
  ...
  \**************************************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                    /*! ./parser */ "./node_modules/sdp-interop/node_modules/sdp-transform/lib/parser.js"
                  ),
                  i = n(
                    /*! ./writer */ "./node_modules/sdp-interop/node_modules/sdp-transform/lib/writer.js"
                  );
                (t.write = i),
                  (t.parse = r.parse),
  ...
  \***************************************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = function (e) {
                  ...
                  o = n(
                    /*! ./grammar */ "./node_modules/sdp-interop/node_modules/sdp-transform/lib/grammar.js"
                  ),
                ...
                var n = (e.exports = {
                  ...
                  a: [
                    ...
                    },
                    {
                      ...
                      format: function (e) {
                        return (
                          "ts-refclk:%s" + (null != e.clksrcExt ? "=%s" : "")
                        );
                      },
                    },
                    {
  ...
  \****************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                  ...
                  s = n(/*! debug */ "./node_modules/debug/src/browser.js")(
                    "socket.io-client"
                  );
                e.exports = t = u;
                var a = (t.managers = {});
                function u(e, t) {
                  ...
                  return (
                    ...
                    !1 === t.multiplex ||
                    d
                      ? (s("ignoring socket cache for %s", u), (n = o(u, t)))
                      : (a[c] ||
                          (s("new io instance for %s", u), (a[c] = o(u, t))),
                        (n = a[c])),
  ...
  \******************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                  ...
                  c = n(/*! debug */ "./node_modules/debug/src/browser.js")(
                ...
                (e.exports = p),
                  ...
                  (p.prototype.onopen = function () {
                    ...
                    this.subs.push(a(e, "data", u(this, "ondata"))),
                      ...
                      this.subs.push(
                        a(this.decoder, "decoded", u(this, "ondecoded"))
                      );
                  }),
  ...
  \**************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(/*! parseuri */ "./node_modules/parseuri/index.js"),
                  i = n(/*! debug */ "./node_modules/debug/src/browser.js")(
  ...
  \************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                var r = n(
                    /*! debug */ "./node_modules/socket.io-parser/node_modules/debug/src/browser.js"
                  )("socket.io-parser"),
                  i = n(
                    /*! component-emitter */ "./node_modules/component-emitter/index.js"
                  ),
                  ...
                  (d.prototype.add = function (e) {
                    ...
                    if ("string" == typeof e)
                      (n = (function (e) {
                        ...
                        if (
                          t.BINARY_EVENT === i.type ||
                          t.BINARY_ACK === i.type
                        ) {
                          for (
                            var o = "";
                            "-" !== e.charAt(++n) &&
                            ((o += e.charAt(n)), n != e.length);
  ...
  \*************************************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                (function (r) {
                  ...
                  ((t = e.exports = n(
                    /*! ./debug */ "./node_modules/socket.io-parser/node_modules/debug/src/debug.js"
                  )).log = function () {
                    return (
                      "object" == typeof console &&
                      console.log &&
  ...
  \***********************************************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                ((t = e.exports = r.debug = r.default = r).coerce = function (
                  e
                ) {
                  return e instanceof Error ? e.stack || e.message : e;
                }),
                  ...
                  (t.humanize = n(
                    /*! ms */ "./node_modules/socket.io-parser/node_modules/ms/index.js"
                  )),
                  (t.instances = []),
                  (t.names = []),
                  (t.skips = []),
  ...
  \**********************************************/
              ...
              /*! ModuleConcatenation bailout: Module is not an ECMAScript module */ function (
                ...
                e.exports = (e, t) => {
                  ...
                  return -1 === n
                    ? [e]
                    : [e.slice(0, n), e.slice(n + t.length)];
                };
              },
  ...
  \**********************************/
              ...
              /*! ModuleConcatenation bailout: Cannot concat with ./package.json (<- Module is not an ECMAScript module) */ function (
                e,
                t,
                n
              ) {
                ...
                const f = new s.a({ NONE: 0, ERROR: 1, WARN: 2, FULL: 3 });
                var p = new (class {
                    constructor() {
                    ...
                    warn(...e) {
                      this._logLevel >= f.WARN.value &&
                        console.warn("SkyWay: ", ...e);
                    }
                    error(...e) {
                      this._logLevel >= f.ERROR.value &&
                        console.error("SkyWay: ", ...e);
                    }
                    log(...e) {
                      this._logLevel >= f.FULL.value &&
                        console.log("SkyWay: ", ...e);
                    }
                  })(),
                  h = n("./package.json");
                class m extends i.a {
                  constructor(e, t) {
                    if (
                      ...
                      const e = t.dispatcherHost || d.DISPATCHER_HOST,
                        ...
                        r =
                          t.dispatcherSecure || d.DISPATCHER_SECURE
                            ? "https://"
                            : "http://";
                  ...
                  get isOpen() {
                    return Boolean(
                      this._io && this._io.connected && this._isOpen
                    );
                  }
                  async start(e, t, n) {
                    let r =
                      `apiKey=${this._key}&token=${t}&platform=javascript&sdk_version=` +
                      h.version;
                    if (
                      (e && ((r += "&peerId=" + e), (this._isPeerIdSet = !0)),
                      n &&
                        (r +=
                          "&credential=" +
                  ...
                  async _connectToNewServer(e = 0) {
                    if (
                      e >= 10 ||
                      this._reconnectAttempts >= d.numberServersToTry
                    )
                  ...
                  _getSignalingServer() {
                    return new Promise((e, t) => {
                      ...
                      (n.timeout = d.DISPATCHER_TIMEOUT),
                        n.open("GET", this._dispatcherUrl, !0),
                        (n.onerror = () => {
                          t(
                            new Error(
                  ...
                  send(e, t) {
                    e
                      ? this.isOpen
                        ? !0 === this._io.connected && this._io.emit(e, t)
                        : this._queue.push({ type: e, message: t })
                  ...
                  updateCredential(e) {
                    ...
                    t.credential
                      ? (t.credential = encodeURIComponent(JSON.stringify(e)))
                      : p.warn(
                          "Adding a credential when one wasn't specified before."
                        ),
                      (this._io.io.opts.query = l.a.stringify(t)),
                      this.send(
                        d.MESSAGE_TYPES.CLIENT.UPDATE_CREDENTIAL.key,
                        e
                      );
                  }
                  _setupMessageHandlers() {
                    d.MESSAGE_TYPES.SERVER.enums.forEach((e) => {
                      e.key === d.MESSAGE_TYPES.SERVER.OPEN.key
                        ? this._io.on(e.key, (t) => {
                            t &&
                              t.peerId &&
                              (this._isPeerIdSet ||
                              ...
                              this._isOpen ||
                                ((this._isOpen = !0), this.emit(e.key, t)));
                          })
                        : this._io.on(e.key, (t) => {
                            this.emit(e.key, t);
                          });
                ...
                var g = m,
                  ...
                  w = new (class {
                    unifiedToPlanB(e) {
                      ...
                      const o = t.replace(
                        "a=msid-semantic:WMS *",
                        "a=msid-semantic:WMS " + Array.from(n).join(" ")
                      );
                    ...
                    addVideoBandwidth(e, t) {
                      return (
                        this._validateBandwidth(t),
                        this._addBandwidth(e, t, "video")
                      );
                    }
                    addAudioBandwidth(e, t) {
                      return (
                        this._validateBandwidth(t),
                        this._addBandwidth(e, t, "audio")
                      );
                    }
                      ...
                      return (
                        (r.media = r.media.map((e) => {
                          if (e.type === n) {
                            ...
                            e.fmtp &&
                              (e.fmtp = e.fmtp.filter((e) =>
                                n.includes(e.payload)
                              )),
                              e.rtcpFb &&
                                (e.rtcpFb = e.rtcpFb.filter((e) =>
                                  n.includes(e.payload)
                                )),
                              (e.payloads = n.join(" "));
                          }
                      ...
                      return (
                        (r.media = r.media.map(
                          (e) => (
                            e.type === n &&
                              (e.bandwidth = [
                                { type: "AS", limit: t.toString() },
                                { type: "TIAS", limit: (1e3 * t).toString() },
                              ]),
                            e
                          )
                        )),
                ...
                class E extends i.a {
                  constructor() {
                    super(),
                      (this._offerQueue = []),
                      (this._isExpectingAnswer = !1),
                      (this._replaceStreamCalled = !1),
                      (this._isNegotiationAllowed = !0),
                      (this.hasRemoteDescription = !1);
                  }
                  async startConnection(e = {}) {
                    if (
                      ((this._pc = this._createPeerConnection(e.pcConfig)),
                      this._setupPCListeners(),
                      (this.originator = e.originator),
                      (this._audioBandwidth = e.audioBandwidth),
                      (this._videoBandwidth = e.videoBandwidth),
                      (this._audioCodec = e.audioCodec),
                      (this._videoCodec = e.videoCodec),
                      (this._type = e.type),
                      "media" === this._type)
                    )
                      if (e.stream) {
                        ...
                        t.length > 0
                          ? t.forEach((t) => this._pc.addTrack(t, e.stream))
                          : r.video &&
                            this._pc.addTransceiver("video", {
                              direction: "recvonly",
                            }),
                          n.length > 0
                            ? n.forEach((t) => this._pc.addTrack(t, e.stream))
                            : r.audio &&
                  ...
                  replaceStream(e) {
                    ...
                    function a(e, n, r) {
                      (void 0 === n && void 0 === e) ||
                        (void 0 !== n
                          ? void 0 !== e
                            ? e.track.id !== n.id && e.replaceTrack(n)
                            : t._pc.addTrack(n, r)
                          : t._pc.removeTrack(e));
                    }
                    a(o, n[0], e), a(s, r[0], e);
                  ...
                  async handleOffer(e) {
                    if (this._lastOffer && e && this._lastOffer.sdp === e.sdp)
                      return;
                    if (
                      ((this._isNegotiationAllowed = !0),
                      e || (e = this._lastOffer),
                      ...
                      return void this._offerQueue.push(e);
                    await this._setRemoteDescription(e);
                    const t = await this._makeAnswerSdp().catch((e) =>
                      p.error(e)
                    );
                  ...
                  async handleCandidate(e) {
                    await this._pc
                      ...
                      .then(() => p.log("Successfully added ICE candidate"))
                      .catch((e) => p.error("Failed to add ICE candidate", e));
                  }
                  cleanup() {
                    p.log("Cleaning up PeerConnection"),
                      !this._pc ||
                        ("closed" === this._pc.readyState &&
                  ...
                  _setupPCListeners() {
                    const e = this._pc;
                    (e.ontrack = (e) => {
                      p.log("Received remote media stream track"),
                        e.streams.forEach((e) => {
                      ...
                      (e.onicecandidate = (e) => {
                        e.candidate && "" !== e.candidate.candidate
                          ? (p.log("Generated ICE candidate for:", e.candidate),
                            this.emit(E.EVENTS.iceCandidate.key, e.candidate))
                          : p.log("ICE candidates gathering complete");
                      }),
                      (e.oniceconnectionstatechange = () => {
                        switch (e.iceConnectionState) {
                          case "completed":
                            p.log("iceConnectionState is completed"),
                              (e.onicecandidate = () => {});
                            break;
                          case "disconnected":
                            p.log(
                          ...
                          case "failed":
                            p.log(
                              ...
                              this.emit(E.EVENTS.iceConnectionFailed.key);
                            break;
                          default:
                            p.log(
                              "iceConnectionState is " + e.iceConnectionState
                            );
                        }
                      }),
                      (e.onconnectionstatechange = () => {
                        p.log("connectionState is " + e.connectionState),
                          "failed" === e.connectionState &&
                            "disconnected" === e.iceConnectionState &&
                            (p.log(
                              "connectionState is failed, closing connection"
                            ),
                            this.emit(E.EVENTS.iceConnectionFailed.key));
                      }),
                      (e.onnegotiationneeded = async () => {
                        if (
                          (p.log("`negotiationneeded` triggered"),
                          "stable" === e.signalingState &&
                            this._isNegotiationAllowed)
                        ) {
                          if (
                            ((this._isNegotiationAllowed = !1), this.originator)
                          ) {
                            const e = await this._makeOfferSdp();
                            this._setLocalDescription(e),
                              this.emit(E.EVENTS.negotiationNeeded.key);
                          } else
                            this._replaceStreamCalled && this.handleOffer();
                          this._replaceStreamCalled = !1;
                        }
                      }),
                      (e.onsignalingstatechange = () => {
                        if (
                          (p.log("signalingState is " + e.signalingState),
                          "stable" === e.signalingState)
                        ) {
                  ...
                  async _makeOfferSdp() {
                    ...
                    try {
                      ...
                      throw (
                        ((e.type = "webrtc"),
                        p.error(e),
                        this.emit(E.EVENTS.error.key, e),
                        p.log("Failed to createOffer, ", e),
                        e)
                      );
                    }
                    return (
                      ...
                      this._audioBandwidth &&
                        (e.sdp = w.addAudioBandwidth(
                          e.sdp,
                          this._audioBandwidth
                        )),
                      this._videoBandwidth &&
                        (e.sdp = w.addVideoBandwidth(
                          e.sdp,
                          this._videoBandwidth
                        )),
                      this._audioCodec &&
                        (e.sdp = w.filterAudioCodec(e.sdp, this._audioCodec)),
                      this._videoCodec &&
                        (e.sdp = w.filterVideoCodec(e.sdp, this._videoCodec)),
                      e
                    );
                  }
                  async _makeAnswerSdp() {
                    ...
                    try {
                      ...
                      throw (
                        ...
                        p.error(e),
                        this.emit(E.EVENTS.error.key, e),
                        p.log("Failed to createAnswer, ", e),
                        e)
                      );
                    }
                    p.log("Created answer."),
                      this._audioBandwidth &&
                        (e.sdp = w.addAudioBandwidth(
                          e.sdp,
                          this._audioBandwidth
                    ...
                    try {
                      ...
                      throw (
                        ...
                        p.error(e),
                        this.emit(E.EVENTS.error.key, e),
                        p.log("Failed to setLocalDescription, ", e),
                        e)
                      );
                    }
                    return (
                      p.log("Set localDescription: answer"),
                      p.log(
                        "Setting local description " + JSON.stringify(e.sdp)
                      ),
                      e
                    );
                  }
                  async _setLocalDescription(e) {
                    ...
                    p.log("Set localDescription: offer"),
                      (this._isExpectingAnswer = !0),
                      this.emit(E.EVENTS.offerCreated.key, e);
                  }
                  async _setRemoteDescription(e) {
                    ...
                    try {
                      ...
                      throw (
                        ...
                        p.error(e),
                        this.emit(E.EVENTS.error.key, e),
                        p.log("Failed to setRemoteDescription: ", e),
                        e)
                      );
                    }
                  ...
                  _getReceiveOnlyState(e = {}) {
                    const t = { audio: !1, video: !1 },
                      n = e.stream instanceof MediaStream,
                      r = !!n && 0 !== e.stream.getAudioTracks().length,
                      i = !!n && 0 !== e.stream.getVideoTracks().length;
                    return !1 === n &&
                      void 0 === e.audioReceiveEnabled &&
                      void 0 === e.videoReceiveEnabled
                      ? ((t.audio = !0), (t.video = !0), t)
                      : (e.audioReceiveEnabled && !1 === r && (t.audio = !0),
                        e.videoReceiveEnabled && !1 === i && (t.video = !0),
                        !1 === e.audioReceiveEnabled &&
                          r &&
                          p.warn(
                            "Option audioReceiveEnabled will be treated as true, because passed stream has MediaStreamTrack(kind = audio)"
                          ),
                        !1 === e.videoReceiveEnabled &&
                          i &&
                          p.warn(
                ...
                var S = E,
                  ...
                  C = {
                    validateId: function (e) {
                      return (
                        !e || /^[A-Za-z0-9_-]+(?:[ _-][A-Za-z0-9]+)*$/.exec(e)
                      );
                    },
                    validateKey: function (e) {
                      return (
                        !e ||
                        /^[a-z0-9]{8}(-[a-z0-9]{4}){3}-[a-z0-9]{12}$/.exec(e)
                      );
                    },
                    randomId: function () {
                      return (
                    ...
                    detectBrowser: function () {
                      const { name: e, version: t } = Object(k.detect)(),
                        [n, r, i] = t.split(".").map((e) => parseInt(e));
                      return { name: e, major: n, minor: r, patch: i };
                    },
                    isPlanBSafari: function () {
                      const { name: e } = Object(k.detect)();
                      return (
                        ("safari" === e || "ios" === e) &&
                ...
                class T extends i.a {
                  constructor(e, t) {
                    if ((super(), (t = t || {}), this.constructor === T))
                      throw new TypeError(
                    ...
                    (this._options = t),
                      ...
                      (this.remoteId = e),
                      (this._negotiator = new S()),
                      (this._idPrefix = "c_"),
                      (this._randomIdSuffix = C.randomToken()),
                  ...
                  async handleAnswer(e) {
                    this._pcAvailable
                      ? (await this._negotiator.handleAnswer(e.answer),
                        (this.open = !0),
                  ...
                  handleCandidate(e) {
                    ...
                    this._negotiator.hasRemoteDescription
                      ? this._pcAvailable
                        ? this._negotiator.handleCandidate(e.candidate)
                        : (p.log(
                  ...
                  updateOffer(e) {
                    this.open
                      ? this._negotiator.handleOffer(e.offer)
                      : (this._options.payload = e);
                  }
                  getPeerConnection() {
                    return this.open ? this._negotiator._pc : null;
                  }
                  _handleQueuedMessages() {
                    for (const e of this._queuedMessages)
                      switch (e.type) {
                  ...
                  close(e = !1) {
                    this.open &&
                      ...
                      this.emit(T.EVENTS.close.key),
                      e && this.emit(T.EVENTS.forceClose.key));
                  }
                  _setupNegotiatorMessageHandlers() {
                    this._negotiator.on(S.EVENTS.answerCreated.key, (e) => {
                      ...
                      this._negotiator.on(S.EVENTS.offerCreated.key, (e) => {
                        ...
                        this.serialization &&
                          (t.serialization = this.serialization),
                          this.label && (t.label = this.label),
                          this.dcInit && (t.dcInit = this.dcInit),
                          this.emit(T.EVENTS.offer.key, t);
                      }),
                      ...
                      this._negotiator.on(
                        S.EVENTS.iceConnectionFailed.key,
                        () => {
                          this.close();
                        }
                      );
                ...
                class B extends A {
                  constructor(e, t) {
                    if (
                      ...
                      (this._idPrefix = "dc_"),
                      (this.type = "data"),
                      (this._isOnOpenCalled = !1),
                      (this.label = this._options.label || this.id),
                      (this.dcInit = this._options.dcInit || {}),
                      (this.serialization = B.SERIALIZATIONS.binary.key),
                      this._options.serialization)
                    ) {
                      if (!B.SERIALIZATIONS.get(this._options.serialization))
                        throw new Error("Invalid serialization");
                      (this.serialization = this._options.serialization),
                        this._isUnreliableDCInit(this.dcInit) &&
                          (p.warn(
                    ...
                    (this._sendBuffer = []),
                      (this._receivedData = {}),
                      (this._queuedMessages =
                        this._options.queuedMessages || []),
                      this._negotiator.on(S.EVENTS.dcCreated.key, (e) => {
                        (this._dc = e),
                          (this._dc.binaryType = "arraybuffer"),
                          this._setupMessageHandlers(),
                          this._isOnOpenCalled ||
                            "open" !== this._dc.readyState ||
                            this._dc.onopen();
                      }),
                  ...
                  _setupMessageHandlers() {
                    (this._dc.onopen = () => {
                      this._isOnOpenCalled ||
                        (p.log("Data channel connection success"),
                        (this.open = !0),
                        (this._isOnOpenCalled = !0),
                        this.emit(B.EVENTS.open.key));
                    }),
                  ...
                  _handleDataMessage(e) {
                    if (this.serialization === B.SERIALIZATIONS.none.key)
                      return void this.emit(B.EVENTS.data.key, e.data);
                    if (this.serialization === B.SERIALIZATIONS.json.key)
                      return void this.emit(
                        B.EVENTS.data.key,
                        JSON.parse(e.data)
                      );
                    ...
                    if (
                      ...
                      n.receivedParts++,
                      (n.parts[t.index] = t.data),
                      n.receivedParts === n.totalParts)
                    ) {
                  ...
                  send(e) {
                    ...
                    if (this.serialization === B.SERIALIZATIONS.none.key)
                      return (
                        this._sendBuffer.push(e), void this._startSendLoop()
                      );
                    if (this.serialization === B.SERIALIZATIONS.json.key)
                      return (
                        this._sendBuffer.push(JSON.stringify(e)),
                        void this._startSendLoop()
                      );
                    const t = P.a.pack(e),
                      n = t.size,
                      r = e.constructor.name,
                      i = { id: C.randomId(), type: r, size: n, totalParts: 0 };
                    "File" === r && (i.name = e.name),
                      e instanceof Blob && (i.mimeType = e.type);
                    ...
                    for (let e = 0; e < s; e++) {
                      ...
                      (i.index = e),
                        (i.data = n),
                        C.blobToArrayBuffer(P.a.pack(i), (e) => {
                  ...
                  _isUnreliableDCInit(e) {
                    return (
                      !!e && ("maxRetransmits" in e || "maxPacketLifeTime" in e)
                    );
                  }
                ...
                class L extends A {
                  ...
                  answer(e, t = {}) {
                    this.localStream
                      ...
                      : ((this._options.payload.stream = e),
                        (this.localStream = e),
                  ...
                  _setupNegotiatorMessageHandlers() {
                    super._setupNegotiatorMessageHandlers(),
                      this._negotiator.on(S.EVENTS.addStream.key, (e) => {
                        p.log("Receiving stream", e),
                          (this.remoteStream &&
                            this.remoteStream.id === e.id) ||
                            ((this.remoteStream = e),
                            this.emit(L.EVENTS.stream.key, e));
                      });
                  }
                  static get EVENTS() {
                    return I;
                ...
                class H extends i.a {
                  constructor(e, t, n = {}) {
                    if ((super(), this.constructor === H))
                      throw new TypeError(
                        "Cannot construct Room instances directly"
                      );
                    (this.name = e),
                      (this._options = n),
                      (this._peerId = t),
                  ...
                  validateSendDataSize(e) {
                    const t = q()([e]),
                      n = { type: t ? U.a.BINARY_EVENT : U.a.EVENT, data: [e] };
                    let r;
                  ...
                  _sendData(e, t) {
                    const n = d.minBroadcastIntervalMs,
                      r = Date.now(),
                      i = r - this.lastsend;
                    if (0 == this.messageQueue.length && i >= n)
                      return (this.lastsend = r), void this.emit(t, e);
                    this.messageQueue.push({ msg: e, key: t }),
                      null === this.sendIntervalID &&
                        (this.sendIntervalID = setInterval(() => {
                          if (0 === this.messageQueue.length)
                            return (
                              clearInterval(this.sendIntervalID),
                              void (this.sendIntervalID = null)
                            );
                ...
                class Q extends $ {
                  ...
                  call(e) {
                    ...
                    const t = { roomName: this.name };
                    this.emit(Q.MESSAGE_EVENTS.offerRequest.key, t);
                  }
                  handleOffer(e) {
                    let t = e.offer;
                    C.isPlanBSafari() && (t = w.unifiedToPlanB(t)),
                      this._connectionStarted
                        ? this._negotiator.handleOffer(t)
                        : (this._negotiator.startConnection({
                            type: "media",
                  ...
                  _setupNegotiatorMessageHandlers() {
                    this._negotiator.on(S.EVENTS.addStream.key, (e) => {
                      ...
                      if (this._msidMap[t.id]) {
                        if (
                          ((t.peerId = this._msidMap[t.id]),
                          t.peerId === this._peerId)
                        )
                          return;
                        const e = this.remoteStreams[t.id];
                        if (e && e.id === t.id) return;
                        (this.remoteStreams[t.id] = t),
                          this.emit(Q.EVENTS.stream.key, t),
                          p.log(
                            `Received remote media stream for ${t.peerId} in ${this.name}`
                          );
                      } else this._unknownStreams[t.id] = t;
                    }),
                      this._negotiator.on(
                        S.EVENTS.negotiationNeeded.key,
                        () => {
                          const e = { roomName: this.name };
                      ...
                      this._negotiator.on(S.EVENTS.answerCreated.key, (e) => {
                        C.isPlanBSafari() ||
                          (e.sdp = w.ensureUnifiedPlan(e.sdp));
                        const t = { roomName: this.name, answer: e };
                      ...
                      this._negotiator.on(S.EVENTS.iceCandidate.key, (e) => {
                        const t = { roomName: this.name, candidate: e };
                        this.emit(Q.MESSAGE_EVENTS.candidate.key, t);
                      });
                  }
                  handleJoin(e) {
                    const { src: t, roomMembers: n } = e;
                    if (t === this._peerId)
                      return (
                        (this._open = !0),
                        (this.members = n.filter((e) => e !== t)),
                        this.call(this._localStream),
                        void this.emit(Q.EVENTS.open.key)
                      );
                  ...
                  handleLeave(e) {
                    ...
                    for (const e in this.remoteStreams)
                      this.remoteStreams[e].peerId === t &&
                        (delete this.remoteStreams[e],
                        delete this._msidMap[e],
                        delete this._unknownStreams[e]);
                    this.emit(Q.EVENTS.peerLeave.key, t);
                  }
                  send(e) {
                    if (!this._open) return;
                    if (!this.validateSendDataSize(e)) return;
                    const t = { roomName: this.name, data: e };
                  ...
                  close() {
                    ...
                    this._negotiator && this._negotiator.cleanup(),
                      (this._open = !1);
                    const e = { roomName: this.name };
                    this.emit(Q.MESSAGE_EVENTS.leave.key, e),
                      this.emit(Q.EVENTS.close.key);
                  }
                  replaceStream(e) {
                ...
                class ee extends $ {
                  ...
                  call(e) {
                    e && (this._localStream = e);
                    const t = { roomName: this.name, type: "media" };
                    this.emit(ee.MESSAGE_EVENTS.getPeers.key, t);
                  }
                  connect() {
                    const e = { roomName: this.name, type: "data" };
                  ...
                  makeDataConnections(e) {
                    const t = { pcConfig: this._pcConfig };
                  ...
                  handleJoin(e) {
                    ...
                    if (t === this._peerId)
                      return (
                        this.call(this._localStream),
                        void this.emit(ee.EVENTS.open.key)
                      );
                    this.emit(ee.EVENTS.peerJoin.key, t);
                  }
                  handleLeave(e) {
                    const t = e.src;
                    this._deleteConnections(t),
                      this.emit(ee.EVENTS.peerLeave.key, t);
                  }
                  handleOffer(e) {
                    ...
                    if (n) n.updateOffer(e);
                      ...
                      if (this._hasConnection(e.src) && this._peerId > e.src)
                        return;
                      (n = new D(e.src, {
                        connectionId: t,
                        payload: e,
                        ...
                        n.startConnection(),
                        p.log("MediaConnection created in OFFER"),
                        this._addConnection(e.src, n),
                        this._setupMessageHandlers(n),
                        n.answer(this._localStream, {
                          videoBandwidth: this._options.videoBandwidth,
                          audioBandwidth: this._options.audioBandwidth,
                          videoCodec: this._options.videoCodec,
                          audioCodec: this._options.audioCodec,
                          videoReceiveEnabled: this._options
                            .videoReceiveEnabled,
                          audioReceiveEnabled: this._options
                            .audioReceiveEnabled,
                        });
                    } else
                      p.warn(
                  ...
                  handleCandidate(e) {
                    ...
                    t
                      ? t.handleCandidate(e)
                      : (void 0 === this._queuedMessages[e.connectionId] &&
                          (this._queuedMessages[e.connectionId] = []),
                        this._queuedMessages[e.connectionId].push({
                          type: d.MESSAGE_TYPES.SERVER.CANDIDATE.key,
                          payload: e,
                        }));
                  }
                  ...
                  close() {
                    for (const e in this.connections)
                      this.connections.hasOwnProperty(e) &&
                        this.connections[e].forEach((e) => {
                          e.close();
                        });
                    const e = { roomName: this.name };
                    this.emit(ee.MESSAGE_EVENTS.leave.key, e),
                      this.emit(ee.EVENTS.close.key);
                  }
                  replaceStream(e) {
                    this._localStream = e;
                    for (const t in this.connections)
                      this.connections.hasOwnProperty(t) &&
                        this.connections[t].forEach((t) => {
                  ...
                  _makeConnections(e, t, n) {
                    e.filter((e) => e !== this._peerId)
                      .filter((e) => !this._hasConnection(e))
                      .forEach((e) => {
                        let r;
                        switch (t) {
                          case "data":
                        ...
                        r.startConnection(),
                          this._addConnection(e, r),
                          this._setupMessageHandlers(r),
                          p.log(
                            `${t} connection to ${e} created in ${this.name}`
                          );
                      });
                  }
                  ...
                  _getConnection(e, t) {
                    return this.connections && this.connections[e]
                      ? this.connections[e].filter((e) => e.id === t)[0]
                      : null;
                  }
                  _hasConnection(e) {
                    return (
                      this.connections[e] && this.connections[e].length > 0
                    );
                  }
                  _setupMessageHandlers(e) {
                    e.on(A.EVENTS.offer.key, (e) => {
                      (e.roomName = this.name),
                        this.emit(ee.MESSAGE_EVENTS.offer.key, e);
                    }),
                      e.on(A.EVENTS.answer.key, (e) => {
                        (e.roomName = this.name),
                          this.emit(ee.MESSAGE_EVENTS.answer.key, e);
                      }),
                      e.on(A.EVENTS.candidate.key, (e) => {
                        (e.roomName = this.name),
                          this.emit(ee.MESSAGE_EVENTS.candidate.key, e);
                      }),
                      "media" === e.type &&
                        e.on(D.EVENTS.stream.key, (t) => {
                          (t.peerId = e.remoteId),
                            this.emit(ee.EVENTS.stream.key, t);
                        });
                  }
                  static get EVENTS() {
                    return X;
                ...
                class re extends i.a {
                  constructor(e, t) {
                    ...
                    (this.options = Object.assign({}, n, t)),
                      (this.options.token = C.randomToken()),
                      p.setLogLevel(this.options.debug),
                      C.validateId(e)
                        ? C.validateKey(t.key)
                          ? ("/" === this.options.host &&
                              (this.options.host = window.location.hostname),
                            void 0 === t.secure &&
                              443 !== this.options.port &&
                              (this.options.secure = void 0),
                            this._initializeServerConnection(e))
                          : this._abort(
                              "invalid-key",
                              `API KEY "${this.options.key}" is invalid`
                            )
                        : this._abort("invalid-id", `ID "${e}" is invalid`);
                  }
                  call(e, t, n = {}) {
                    if (!this._checkOpenStatus()) return;
                    (n.originator = !0),
                      (n.stream = t),
                      (n.pcConfig = this._pcConfig);
                    const r = new D(e, n);
                    return (
                      r.startConnection(),
                      p.log("MediaConnection created in call method"),
                      this._addConnection(e, r),
                      r
                    );
                  }
                  connect(e, t = {}) {
                    ...
                    return (
                      n.startConnection(),
                      p.log("DataConnection created in connect method"),
                      this._addConnection(e, n),
                      n
                    );
                  }
                  joinRoom(e, t = {}) {
                    if (this._checkOpenStatus()) {
                      if (!e) {
                        ...
                        return (
                          (e.type = "room-error"),
                          p.error(e),
                          this.emit(re.EVENTS.error.key, e),
                          null
                        );
                      }
                      return (
                        ...
                        (t.peerId = this.id),
                        "sfu" === t.mode
                          ? this._initializeSfuRoom(e, t)
                          : this._initializeFullMeshRoom(e, t)
                      );
                    }
                  }
                  getConnection(e, t) {
                  ...
                  disconnect() {
                    this.open &&
                      (this.socket.close(),
                      this.emit(re.EVENTS.disconnected.key, this.id));
                  }
                  reconnect() {
                      ...
                      (n.onreadystatechange = function () {
                        if (4 === n.readyState)
                          if (401 === n.status) {
                            e([]);
                            const n = new Error(
                              "It doesn't look like you have permission to list peers IDs. Please enable the SkyWay REST API on dashboard"
                            );
                            (n.type = "list-error"),
                              p.error(n),
                              t.emit(re.EVENTS.error.key, n);
                          } else
                            200 === n.status
                  ...
                  _checkOpenStatus() {
                    return (
                      this.open || this._emitNotConnectedError(), this.open
                    );
                  }
                  _emitNotConnectedError() {
                    p.warn(
                      "You cannot connect to a new Peer because you are not connecting to SkyWay server now.You can create a new Peer to reconnect, or call reconnect() on this peer if you believe its ID to still be available."
                    );
                    const e = new Error(
                  ...
                  _initializeSfuRoom(e, t = {}) {
                    ...
                    const r = { roomName: e, roomType: "sfu" };
                    return (
                      this.socket.send(d.MESSAGE_TYPES.CLIENT.ROOM_JOIN.key, r),
                      n
                    );
                  }
                  _initializeFullMeshRoom(e, t = {}) {
                    ...
                    const r = { roomName: e, roomType: "mesh" };
                    return (
                      this.socket.send(d.MESSAGE_TYPES.CLIENT.ROOM_JOIN.key, r),
                      n
                    );
                  ...
                  _setupMessageHandlers() {
                    this.socket.on(d.MESSAGE_TYPES.SERVER.OPEN.key, (e) => {
                      ...
                      if (
                        ("object" == typeof n
                          ? ((r = n.username), (i = n.credential))
                          : "string" == typeof n &&
                            ((r = `${this.options.key}$${this.id}`), (i = n)),
                        !0 === this.options.turn && r && i)
                      ) {
                        const e = [
                          { protocol: "turn", transport: "tcp" },
                          { protocol: "turn", transport: "udp" },
                        ];
                        "edge" !== C.detectBrowser().name &&
                          e.push({ protocol: "turns", transport: "tcp" });
                        for (const t of e) {
                          const e = t.protocol,
                            n = t.transport,
                            o = {
                      ...
                      this.socket.on(d.MESSAGE_TYPES.SERVER.ERROR.key, (e) => {
                        ...
                        (t.type = e.type),
                          p.error(t),
                          this.emit(re.EVENTS.error.key, t);
                      }),
                      this.socket.on(d.MESSAGE_TYPES.SERVER.LEAVE.key, (e) => {
                        p.log("Received leave message from " + e),
                          this._cleanupPeer(e);
                      }),
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.FORCE_CLOSE.key,
                        ({ src: e, connectionId: t }) => {
                          const n = this.getConnection(e, t);
                          n && n.close(!1);
                        }
                      ),
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.AUTH_EXPIRES_IN.key,
                        (e) => {
                          p.log("Credential expires in " + e),
                            this.emit(re.EVENTS.expiresin.key, e);
                        }
                      ),
                        ...
                        r
                          ...
                          : ("media" === e.connectionType
                              ? ((r = new D(e.src, {
                                ...
                                r.startConnection(),
                                p.log("MediaConnection created in OFFER"),
                                this._addConnection(e.src, r),
                                this.emit(re.EVENTS.call.key, r))
                              : "data" === e.connectionType
                              ? ((r = new F(e.src, {
                                  connectionId: n,
                                  payload: e,
                                  metadata: e.metadata,
                                ...
                                r.startConnection(),
                                p.log("DataConnection created in OFFER"),
                                this._addConnection(e.src, r),
                                this.emit(re.EVENTS.connection.key, r))
                              : p.warn(
                                  "Received malformed connection type: ",
                                  e.connectionType
                                ),
                            delete this._queuedMessages[n]);
                      }),
                      this.socket.on(d.MESSAGE_TYPES.SERVER.ANSWER.key, (e) => {
                        ...
                        n
                          ? n.handleAnswer(e)
                          : this._storeMessage(
                              d.MESSAGE_TYPES.SERVER.ANSWER.key,
                              e
                            );
                      }),
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.CANDIDATE.key,
                        (e) => {
                          const t = e.roomName;
                          if (t) {
                            const n = this.rooms[t];
                      ...
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.ROOM_USER_JOIN.key,
                        (e) => {
                      ...
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.ROOM_USER_LEAVE.key,
                        (e) => {
                          const t = this.rooms[e.roomName];
                          t && t.handleLeave(e);
                        }
                      ...
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.ROOM_DATA.key,
                        (e) => {
                          const t = this.rooms[e.roomName];
                          t && t.handleData(e);
                        }
                      ...
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.ROOM_LOGS.key,
                        (e) => {
                          const t = this.rooms[e.roomName];
                          t && t.handleLog(e.log);
                        }
                      ...
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.ROOM_USERS.key,
                        (e) => {
                          const t = this.rooms[e.roomName];
                          t &&
                            ("media" === e.type
                              ? t.makeMediaConnections(e.userList)
                              : t.makeDataConnections(e.userList));
                        }
                      ),
                      this.socket.on(
                        d.MESSAGE_TYPES.SERVER.SFU_OFFER.key,
                        (e) => {
                          const t = this.rooms[e.roomName];
                  ...
                  _setupConnectionMessageHandlers(e) {
                    e.on(A.EVENTS.candidate.key, (e) => {
                      this.socket.send(
                        d.MESSAGE_TYPES.CLIENT.SEND_CANDIDATE.key,
                        e
                      );
                    }),
                      e.on(A.EVENTS.answer.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SEND_ANSWER.key,
                          e
                        );
                      }),
                      e.on(A.EVENTS.offer.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SEND_OFFER.key,
                          e
                        );
                      }),
                      e.on(A.EVENTS.forceClose.key, () => {
                        const t = { dst: e.remoteId, connectionId: e.id };
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SEND_FORCE_CLOSE.key,
                          t
                        );
                      });
                  }
                  _setupRoomMessageHandlers(e) {
                    e.on(J.MESSAGE_EVENTS.broadcast.key, (e) => {
                      this.socket.send(
                        d.MESSAGE_TYPES.CLIENT.ROOM_SEND_DATA.key,
                        e
                      );
                    }),
                      e.on(J.MESSAGE_EVENTS.getLog.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.ROOM_GET_LOGS.key,
                          e
                        );
                      }),
                      e.on(J.MESSAGE_EVENTS.leave.key, (t) => {
                        delete this.rooms[e.name],
                          this.socket.send(
                            d.MESSAGE_TYPES.CLIENT.ROOM_LEAVE.key,
                            t
                          );
                      });
                  }
                  _setupSFURoomMessageHandlers(e) {
                    this._setupRoomMessageHandlers(e),
                      e.on(J.MESSAGE_EVENTS.offerRequest.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SFU_GET_OFFER.key,
                          e
                        );
                      }),
                      e.on(J.MESSAGE_EVENTS.answer.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SFU_ANSWER.key,
                          e
                        );
                      }),
                      e.on(J.MESSAGE_EVENTS.candidate.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SFU_CANDIDATE.key,
                          e
                        );
                      });
                  }
                  _setupMeshRoomMessageHandlers(e) {
                    this._setupRoomMessageHandlers(e),
                      e.on(te.MESSAGE_EVENTS.offer.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.SEND_OFFER.key,
                          e
                        );
                      ...
                      e.on(te.MESSAGE_EVENTS.getPeers.key, (e) => {
                        this.socket.send(
                          d.MESSAGE_TYPES.CLIENT.ROOM_GET_USERS.key,
                          e
                        );
                      });
                  }
                  ...
                  _addConnection(e, t) {
                    this.connections[e] || (this.connections[e] = []),
                      this.connections[e].push(t),
                      this._setupConnectionMessageHandlers(t);
                  }
                  _storeMessage(e, t) {
                    this._queuedMessages[t.connectionId] ||
                      (this._queuedMessages[t.connectionId] = []),
                      this._queuedMessages[t.connectionId].push({
                        type: e,
                        payload: t,
                      });
                  }
                  _cleanup() {
                    if (this.connections)
                      for (const e of Object.keys(this.connections))
                        this._cleanupPeer(e);
  ...
  \********************/
          ...
          l.map((t) =>
            Object(a.c)(
              ...
              Object(a.c)(
                "button",
                { css: h, onClick: () => e(t) },
                Object(a.c)("i", { css: m }, t)
              )
            )
          )
        );
      const f = Object(a.b)(
          { position: "absolute", top: 0, right: c.b, zIndex: c.d.modal },
          ";label:wrapperStyle;"
        ),
        p = Object(a.b)(
          {
        ...
        h = {
          ...
          styles:
            "width:100%;height:100%;padding:0 1;appearance:none;border:none;background:none;color:inherit;cursor:pointer;;label:reactionStyle;",
        },
        m = {
        ...
        v = () => {
          const e = Object(r.useContext)(o.a),
            t = Object(r.useCallback)(
              (({ ui: e }) => () => {
                y("toggleReaction() -> " + !e.isReactionOpen),
                  (e.isReactionOpen = !e.isReactionOpen);
              })(e),
              [e]
            ),
            ...
            { ui: u } = e;
          return Object(a.c)(i.a, null, () =>
            Object(a.c)(
              r.Fragment,
              null,
              Object(a.c)(s.c, { name: "insert_emoticon", onClick: t }),
              u.isReactionOpen ? Object(a.c)(d, { onClickSend: n }) : null
            )
          );
        };
    },
    function (e, t, n) {
      ...
      function T(e, t, n) {
        ...
        if (null != t)
          ...
          t))
            C.call(t, r) && !x.hasOwnProperty(r) && (i[r] = t[r]);
    ...
    function (e, t, n) {
      ...
      function Ge(e) {
        ...
        var t,
          n = ze[e];
        for (t in n) if (n.hasOwnProperty(t) && t in We) return (qe[e] = n[t]);
        return e;
      }
      T &&
          ...
          extractEvents: function (e, t, n, r) {
            ...
            return (
              o
                ? (er &&
                    "ko" !== n.locale &&
                    (sr || o !== nr.compositionStart
                      ? o === nr.compositionEnd && sr && (i = Un())
      ...
      function wr(e, t, n) {
        "focus" === e
          ? (vr(), (pr = n), (fr = t).attachEvent("onpropertychange", br))
          : "blur" === e && vr();
      }
      function _r(e) {
        ...
        Fr = {
          ...
          extractEvents: function (e, t, n, r, i) {
            ...
            if (
              ((e = null == s ? o : On(s)),
              (o = null == t ? o : On(t)),
              ((u = a.getPooled(u, s, n, r)).type = l + "leave"),
              (u.target = e),
              (u.relatedTarget = o),
            ...
            for (
              c = a, a = [];
              r && r !== c && (null === (s = r.alternate) || s !== c);

            )
              a.push(r), (r = Nn(r));
            for (
              r = [];
              l && l !== c && (null === (s = l.alternate) || s !== c);
        ...
        return Gr || null == zr || zr !== ln(n)
          ...
          : ("selectionStart" in (n = zr) && hn(n)
            ...
            Wr && Dr(Wr, n)
              ? null
              : ((Wr = n),
                ((e = Wn.getPooled(Ur.select, qr, e, t)).type = "select"),
                (e.target = zr),
                In(e),
                e));
      }
      ...
      function no(e, t) {
        (Qi = e),
          ...
          null !== (e = e.dependencies) &&
            null !== e.firstContext &&
            (e.expirationTime >= t && (Ps = !0), (e.firstContext = null));
      }
      function ro(e, t) {
        if (Xi !== e && !1 !== t && 0 !== t)
          if (
      ...
      function ko(e) {
        ...
        function c(e, t, n, r) {
          return null !== t && t.elementType === n.type
            ...
            : (((r = Tu(n.type, n.key, n.props, null, e.mode, r)).ref = Eo(
                e,
                t,
                n
              )),
        ...
        function m(i, s, a, u) {
          for (
            var c = null, l = null, d = s, m = (s = 0), g = null;
            null !== d && m < a.length;
            m++
          ) {
        ...
        function g(i, a, u, c) {
          ...
          for (
            var d = (l = null), m = a, g = (a = 0), y = null, v = u.next();
            null !== m && !v.done;
            g++, v = u.next()
          ) {
      ...
      function Yo(e, t, n, r, i, o) {
        if (
          ...
          (t.updateQueue = null),
          (t.expirationTime = 0),
          (Do.current = null === e || null === e.memoizedState ? ys : vs),
          (e = n(r, i)),
          t.expirationTime === Uo)
        ) {
          o = 0;
      ...
      function Ko() {
        ...
        return (
          null === Wo ? (zo.memoizedState = Wo = e) : (Wo = Wo.next = e), Wo
        );
      }
      function Qo() {
        if (null === qo) {
          ...
          do {
            ...
            if (l < Uo) {
              ...
              null === u ? ((a = u = d), (o = r)) : (u = u.next = d),
                l > zo.expirationTime && ((zo.expirationTime = l), su(l));
            } else
              null !== u &&
                (u = u.next = {
                  expirationTime: 1073741823,
      ...
      function is(e, t, n, r) {
        ...
        if (null !== qo) {
          ...
          if (((o = s.destroy), null !== r && $o(r, s.deps)))
            return void ts(t, n, o, r);
        }
      ...
      function ms(e, t, n) {
        ...
        if (
          ...
          (Go = !0), (i.expirationTime = Uo), (zo.expirationTime = Uo);
        else {
          if (
            0 === e.expirationTime &&
      ...
      function Ms(e, t, n, r, i) {
        ...
        return (
          ...
          (r = Yo(e, t, n, r, o, i)),
          null === e || Ps
            ? ((t.effectTag |= 1), Ns(e, t, r, i), t.child)
        ...
        if (null === e) {
          ...
          return "function" != typeof s ||
            ...
            ? (((e = Tu(n.type, null, r, null, t.mode, o)).ref = t.ref),
              (e.return = t),
              (t.child = e))
            : ((t.tag = 15), (t.type = s), js(e, t, s, r, i, o));
        }
        return (
          (s = e.child),
          i < o &&
      ...
      function js(e, t, n, r, i, o) {
        return null !== e &&
          ...
          e.ref === t.ref &&
          ((Ps = !1), i < o)
          ? ((t.expirationTime = e.expirationTime), Ys(e, t, o))
          : Fs(e, t, n, r, o);
      }
      function Bs(e, t) {
        var n = t.ref;
      ...
      function Fs(e, t, n, r, i) {
        ...
        return (
          ...
          (n = Yo(e, t, n, r, o, i)),
          null === e || Ps
            ? ((t.effectTag |= 1), Ns(e, t, n, i), t.child)
            : ((t.updateQueue = e.updateQueue),
              (t.effectTag &= -517),
              e.expirationTime <= i && (e.expirationTime = 0),
              Ys(e, t, i))
      ...
      function Is(e, t, n, r, i) {
        ...
        if ((no(t, i), null === t.stateNode))
          ...
          (s.state = f),
            lo(t, r, s, i),
            (u = t.memoizedState),
            a !== r || f !== u || fi.current || io
              ? ("function" == typeof l &&
                  (mo(t, n, l, r), (u = t.memoizedState)),
                (a = io || yo(t, n, a, r, f, u, c))
                  ? (d ||
          ...
          (s = t.stateNode),
            so(e, t),
            (a = t.memoizedProps),
            (s.props = t.type === t.elementType ? a : Yi(t.type, a)),
            (u = s.context),
            ...
            lo(t, r, s, i),
            (f = t.memoizedState),
            a !== r || u !== f || fi.current || io
              ? ("function" == typeof l &&
                  (mo(t, n, l, r), (f = t.memoizedState)),
                (l = io || yo(t, n, a, r, u, f, c))
                  ? (d ||
                      ("function" != typeof s.UNSAFE_componentWillUpdate &&
                        "function" != typeof s.componentWillUpdate) ||
                      ("function" == typeof s.componentWillUpdate &&
                        s.componentWillUpdate(r, f, c),
                      "function" == typeof s.UNSAFE_componentWillUpdate &&
                        s.UNSAFE_componentWillUpdate(r, f, c)),
      ...
      function $s(e, t, n) {
        var r = t.pendingProps,
          i = r.revealOrder,
          o = r.tail;
        if ((Ns(e, t, r.children, n), 0 != (2 & (r = Fo.current))))
        ...
        switch (t.tag) {
          ...
          case 3:
            return (
              ...
              (null !== e && null !== e.child) || !Ts(t) || (t.effectTag |= 4),
              null
            );
          case 5:
            ...
            if (null !== e && null != t.stateNode)
              Us(e, t, o, r, n), e.ref !== t.ref && (t.effectTag |= 128);
            else {
              if (!r) {
                ...
                for (a in l)
                  if (l.hasOwnProperty(a)) {
                    ...
                    "style" === a
                      ...
                      ? null != (d = d ? d.__html : void 0) && De(e, d)
                      : "children" === a
                      ? "string" == typeof d
                        ? ("textarea" !== o || "" !== d) && Ve(e, d)
            ...
            return (
              ...
              0 != (64 & t.effectTag)
                ...
                : ((n = null !== r),
                  (r = !1),
                  null === e
                    ? void 0 !== t.memoizedProps.fallback && Ts(t)
                  ...
                  n &&
                    ...
                    0 != (1 & Fo.current)
                      ? Ta === wa && (Ta = _a)
                      : ((Ta !== wa && Ta !== _a) || (Ta = Ea),
                        0 !== Ma && null !== ka && (Ru(ka, xa), ju(ka, Ma)))),
                  (n || r) && (t.effectTag |= 4),
                  null)
            );
          case 4:
      ...
      function Js(e) {
        switch (e.tag) {
          ...
          case 3:
            if ((Ro(), ui(fi), ui(di), 0 != (64 & (t = e.effectTag))))
              throw Error(s(285));
        ...
        (Us = function (e, t, n, r, o) {
          ...
          if (s !== r) {
            ...
            for (a in r) {
              ...
              if (
                ((c = null != s ? s[a] : void 0),
                r.hasOwnProperty(a) && l !== c && (null != l || null != c))
              )
                if ("style" === a)
                  if (c) {
                    for (u in c)
        ...
        for (var r, i, o = t, a = !1; ; ) {
          ...
          if (5 === o.tag || 6 === o.tag) {
            e: for (var u = e, c = o, l = n, d = c; ; )
              if ((sa(u, d, l), null !== d.child && 4 !== d.tag))
      ...
      function Ka(e, t) {
        ...
        return (
          null !== i && (ka === i && (su(t), Ta === Ea && Ru(i, xa)), ju(i, t)),
          i
        );
      }
      function Qa(e) {
      ...
      function Xa(e, t) {
        ...
        if (0 !== n) {
          ...
          if ((mu(), (e === ka && n === xa) || nu(e, n), null !== Ca)) {
            ...
            if ((Zi(), (Sa = r), (va.current = i), 1 === Ta))
              throw ((t = Aa), nu(e, n), Ru(e, n), Ja(e), t);
            if (null === Ca)
              switch (
                ...
                case _a:
                  if (
                    ...
                    n === (r = e.lastSuspendedTime) &&
                      (e.nextKnownPendingLevel = du(i)),
                    1073741823 === Oa && 10 < (i = ja + 500 - Di()))
                  ) {
                    if (Ra) {
      ...
      function Za(e) {
        ...
        if ((mu(), (e === ka && t === xa) || nu(e, t), null !== Ca)) {
          ...
          if ((Zi(), (Sa = n), (va.current = r), 1 === Ta))
            throw ((n = Aa), nu(e, t), Ru(e, t), Ja(e), n);
          ...
          try {
            ...
            e: {
              ...
              if (
                ...
                if (0 == (2 & s.mode)) {
                  ...
                  c
                    ? ((s.updateQueue = c.updateQueue),
                      ...
                      (s.expirationTime = c.expirationTime))
                ...
                a = Error(
                  (ge(s.type) || "A React component") +
                    " suspended while rendering, but no fallback UI was specified.\n\nAdd a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display." +
                    ye(s)
                );
              }
              5 !== Ta && (Ta = 2), (a = Xs(a, s)), (d = o);
              do {
                switch (d.tag) {
                  case 3:
                    (u = a),
      ...
      function lu(e) {
        ...
        do {
          ...
          if (((e = Ca.return), 0 == (2048 & Ca.effectTag))) {
            if (
              ((t = Qs(t, Ca, xa)), 1 === xa || 1 !== Ca.childExpirationTime)
            ) {
      ...
      function pu(e, t) {
        ...
        if (
              ...
              e: {
                ...
                if (c && 0 !== c.rangeCount) {
                  ...
                  t: for (;;) {
                    for (
                      var b;
                      y !== u || (0 !== l && 3 !== y.nodeType) || (p = f + l),
                        y !== d || (0 !== c && 3 !== y.nodeType) || (h = f + c),
          ...
          if (
            ...
            null !== u &&
              ...
              "selectionStart" in w
                ...
                : (E =
                  ...
                  (a = Math.min(u.start, l)),
                  (u = void 0 === u.end ? a : Math.min(u.end, l)),
                  !E.extend && a > u && ((l = u), (u = a), (a = l)),
                  (l = fn(w, a)),
                  (d = fn(w, u)),
                  l &&
                    d &&
                    ...
                    E.removeAllRanges(),
                    a > u
                      ? (E.addRange(_), E.extend(d.node, d.offset))
                      : (_.setEnd(d.node, d.offset), E.addRange(_))))),
              (_ = []);
            ...
            for (
              ...
              ((E = _[w]).element.scrollLeft = E.left),
        ...
        if (
          ...
          throw ((Fa = !1), (e = Ia), (Ia = null), e);
        return 0 != (8 & Sa) || Gi(), null;
      }
      function hu() {
        for (; null !== Ba; ) {
          var e = Ba.effectTag;
          0 != (256 & e) && na(Ba.alternate, Ba),
            0 == (512 & e) ||
              Da ||
              ((Da = !0),
              qi(97, function () {
      ...
      function yu(e, t, n) {
        uo(e, (t = ha(e, (t = Xs(n, t)), 1073741823))),
          null !== (e = Ka(e, 1073741823)) && Ja(e);
      }
      function vu(e, t) {
        if (3 === e.tag) yu(e, e, t);
        else
          for (var n = e.return; null !== n; ) {
            ...
            if (1 === n.tag) {
              ...
              if (
                ...
                uo(n, (e = ma(n, (e = Xs(t, e)), 1073741823))),
                  null !== (n = Ka(n, 1073741823)) && Ja(n);
                break;
              }
            }
            n = n.return;
      ...
      function bu(e, t, n) {
        ...
        null !== r && r.delete(t),
          ka === e && xa === n
            ? Ta === Ea || (Ta === _a && 1073741823 === Oa && Di() - ja < 500)
              ? nu(e, xa)
              : (Ra = !0)
            : Mu(e, n) &&
              ((0 !== (t = e.lastPingedTime) && t < n) ||
                ((e.lastPingedTime = n), Ja(e)));
      }
      function wu(e, t) {
        var n = e.stateNode;
        null !== n && n.delete(t),
                ...
                case 13:
                  if (null !== t.memoizedState)
                    return 0 !== (r = t.child.childExpirationTime) && r >= n
                      ? Ws(e, t, n)
                      : (ci(Fo, 1 & Fo.current),
                        null !== (t = Ys(e, t, n)) ? t.sibling : null);
                  ci(Fo, 1 & Fo.current);
                  break;
                case 19:
                  if (
        ...
        switch (((t.expirationTime = 0), t.tag)) {
          ...
          case 0:
            return (
              (r = t.type),
              (i = t.pendingProps),
              Fs(e, t, r, (i = t.elementType === r ? i : Yi(r, i)), n)
            );
          case 1:
            return (
              (r = t.type),
              (i = t.pendingProps),
              Is(e, t, r, (i = t.elementType === r ? i : Yi(r, i)), n)
            );
          case 3:
            if ((Ds(t), (r = t.updateQueue), null === e || null === r))
              throw Error(s(282));
            if (
              ((r = t.pendingProps),
              ...
              if (
                ((i = t.stateNode.hydrate) &&
                  ((_s = _n(t.stateNode.containerInfo.firstChild)),
                  (ws = t),
                  (i = Es = !0)),
                i)
              )
          ...
          case 4:
            return (
              Mo(t, t.stateNode.containerInfo),
              (r = t.pendingProps),
              null === e ? (t.child = Co(t, null, r, n)) : Ns(e, t, r, n),
              t.child
            );
          case 11:
            return (
              (r = t.type),
              (i = t.pendingProps),
              Ms(e, t, r, (i = t.elementType === r ? i : Yi(r, i)), n)
            );
          case 7:
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        var s,
          ...
          p = t.history || 10,
          h = !0;
        (o = t.audioContext || o || new r()),
          ((u = o.createAnalyser()).fftSize = 512),
          (u.smoothingTimeConstant = c),
          (a = new Float32Array(u.frequencyBinCount)),
          e.jquery && (e = e[0]),
          e instanceof HTMLAudioElement || e instanceof HTMLVideoElement
            ? ((s = o.createMediaElementSource(e)),
              void 0 === f && (f = !0),
              (d = d || -50))
            : ((s = o.createMediaStreamSource(e)), (d = d || -50)),
          s.connect(u),
          f && u.connect(o.destination),
          (n.speaking = !1),
          (n.suspend = function () {
            return o.suspend();
          }),
          ...
          (n.stop = function () {
            (h = !1),
              n.emit("volume_change", -100, d),
              n.speaking && ((n.speaking = !1), n.emit("stopped_speaking")),
              u.disconnect(),
              s.disconnect();
          }),
          (n.speakingHistory = []);
        ...
        var g = function () {
          setTimeout(function () {
            if (h) {
              ...
              if (e > d && !n.speaking) {
                for (
                  var r = n.speakingHistory.length - 3;
                  r < n.speakingHistory.length;
                  r++
                )
                  t += n.speakingHistory[r];
                t >= 2 && ((n.speaking = !0), n.emit("speaking"));
              } else if (e < d && n.speaking) {
                for (r = 0; r < n.speakingHistory.length; r++)
                  t += n.speakingHistory[r];
                0 == t && ((n.speaking = !1), n.emit("stopped_speaking"));
              }
              n.speakingHistory.shift(),
                n.speakingHistory.push(0 + (e > d)),
                g();
            }
          }, l);
        };
      ...
      (function (e) {
        ...
        function h() {
          ...
          for (t = n ? t : t[Symbol.iterator](); ; ) {
            ...
            s &&
              e >= s.cleanAt &&
              (s.reaction.dispose(), (o.current = null), f.delete(o));
          }
          f.size > 0 && p();
        }
        var m = {};
        ...
        function y(e, t, n) {
          if ((void 0 === t && (t = "observed"), void 0 === n && (n = m), a()))
            return e();
          var i,
            s = (n.useForceUpdate || u)(),
            l = o.a.useRef(null);
          if (!l.current) {
          ...
          var v,
            b,
            w = l.current.reaction;
          if (
            (o.a.useDebugValue(w, c),
        ...
        (v.propTypes = { children: b, render: b }),
